...
export default function Dashboard(): JSX.Element {
	...
	const [data, loading, error] = getUserData(userID)
	...
	return (
		<>
			...
			{loading ? (
				...
				<div className="error">Erreur lors de la recherche des données...</div>
			) : (
				<div className="main-container">
					<Title
						text="Bonjour"
						textColor={data["userInfos"]["firstName"]}
						subText={"Félicitation ! Vous avez explosé vos objectifs hier 👏"}
					/>
